...
type Task = { id: string; time: string; title: string; icon: string; done: boolean; color?: TaskColor; customColor?: string; lastTriggered?: string };
...
const createInitialState = (): PlannerState => ({
  ...
  settings: { language: "ar", theme: "dark", prayerCity: "damascus", prayerMethod: 4, prayerAlerts: true, wake: "08:00", sleep: "23:00", school: "12:00–16:00", taskReminders: true, notificationSound: "soft" },
});
