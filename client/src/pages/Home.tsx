...
type PlannerState = {
  ...
  week: WeekDay[];
  settings: { language: Language; theme: AppTheme; prayerCity: string; wake: string; sleep: string; school: string; taskReminders: boolean; notificationSound: NotificationSound };
};
...
const createInitialState = (): PlannerState => ({
  ...
  settings: { language: "ar", theme: "dark", prayerCity: "damascus", wake: "08:00", sleep: "23:00", school: "12:00–16:00", taskReminders: true, notificationSound: "soft" },
});
